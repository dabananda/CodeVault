...
def replace_between(text, start, end, replacement, inline=False):
...
# Side-by-side layout via an HTML table (renders fine on GitHub, unlike
# plain Markdown tables which always stack vertically).
stats_block = (
    "<table>\n<tr>\n"
    "<td valign=\"top\">\n\n"
...
readme = replace_between(readme, "<!-- START_STATS -->", "<!-- END_STATS -->", stats_block)
readme = replace_between(readme, "<!-- START_LAST_UPDATED -->", "<!-- END_LAST_UPDATED -->", last_updated, inline=True)
